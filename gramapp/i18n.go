...
var catalogs = map[string]map[string]string{
	"en": {
		...
		"step.hw.ram2":          "      RAM  %.0f GB  free %.1f GB  load %.0f%%    GPU  %s",
		"step.hw.profile":       "      → %s",
		"step.hw.tune":          "      ctx %d · chunk %d · predict %d",
		"step.hw.where":         "      Engine/packs: GitHub. Model files: Hugging Face. Nothing is uploaded.",
		"step.hw.derate":        "      Free RAM is tight. Using 8B and a smaller window.",
		...
		"step.vcredist":         "      Installing the Windows C++ runtime (once).",
		"step.vcredist.fail":    "      C++ runtime download failed: %s — llama.cpp may not start.",
		...
		"job.pack":              "Job: %s",
		"job.onebyone":          "Each file is a separate job (%d files). Nothing is merged across files.",
		"job.file":              "[%d/%d] %s",
		...
		"run.split":             "  split long source %d → %d segments",
		"run.dump":              "  work folder %s",
		...
		"run.skel":              "Assemble was thin; Word is filled from extracted facts.",
		"skel.h1":               "1. Overview",
		"skel.h2":               "2. Key points",
		"skel.h3":               "3. Figures",
	...
	"ko": {
		...
		"step.hw.ram":           "      RAM  %.0f GB    GPU  %s",
		"step.hw.ram2":          "      RAM  %.0f GB  여유 %.1f GB  부하 %.0f%%    GPU  %s",
		"step.hw.profile":       "      → %s",
		"step.hw.tune":          "      ctx %d · chunk %d · predict %d",
		"step.hw.where":         "      엔진·팩은 GitHub, 모델 파일은 Hugging Face. 이 PC에서 나가지 않습니다.",
		"step.hw.derate":        "      지금 메모리가 빠듯해서 8B와 작은 창으로 돌립니다.",
		...
		"step.vcredist":         "      Windows C++ 실행 파일을 한 번 설치합니다.",
		"step.vcredist.fail":    "      C++ 런타임 받기 실패: %s — 엔진이 안 켜질 수 있습니다.",
		...
		"job.pack":              "용도: %s",
		"job.onebyone":          "파일마다 따로 돌립니다 (%d개). 파일 사이에 내용을 합치지 않습니다.",
		"job.file":              "[%d/%d] %s",
